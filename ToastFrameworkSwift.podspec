#
#  Be sure to run `pod spec lint ToastFrameworkSwift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
    A toast framework written in Swift.
                   DESC
  ...
  # Or just: spec.author    = "George Mihoc"
  # spec.authors            = { "George Mihoc" => "george.mihoc@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/George Mihoc"
